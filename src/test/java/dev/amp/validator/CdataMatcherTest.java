...
public class CdataMatcherTest {
    ...
    @Test
    public void testMatchViolateDisallowedlist() throws TagValidationException, CssValidationException, IOException {
        final ValidatorProtos.TagSpec.Builder tagSpecBuilder = ValidatorProtos.TagSpec.newBuilder();
        tagSpecBuilder.setSpecName("title");

        final ValidatorProtos.CdataSpec.Builder cDataBuilder = ValidatorProtos.CdataSpec.newBuilder();
        cDataBuilder.setMaxBytes(6);
        cDataBuilder.addDisallowedCdataRegex(ValidatorProtos.DisallowedCDataRegex.newBuilder().setRegex("cdata").build());
        ...
        final ParsedValidatorRules mockParsedValidatorRules = Mockito.mock(ParsedValidatorRules.class);
        Mockito.when(mockParsedValidatorRules.getCombinedDisallowedCdataRegex(Mockito.anyInt())).thenReturn("cdata");
    ...
    public void testMatchPartialMatch() throws TagValidationException, CssValidationException, IOException {
        ...
        final ValidatorProtos.CdataSpec.Builder cDataBuilder = ValidatorProtos.CdataSpec.newBuilder();
        cDataBuilder.setMaxBytes(6);
        cDataBuilder.addDisallowedCdataRegex(ValidatorProtos.DisallowedCDataRegex.newBuilder().setRegex("cdata1").build());
        ...
        final ParsedValidatorRules mockParsedValidatorRules = Mockito.mock(ParsedValidatorRules.class);
        Mockito.when(mockParsedValidatorRules.getCombinedDisallowedCdataRegex(Mockito.anyInt())).thenReturn("xyz");
